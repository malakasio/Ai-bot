        ...
        "phases": [
            {
                ...
                "steps": [
                    ...
                    {"step": "Count errors", "command": "wc -l /tmp/ruff_before.txt"},
                ],
            },
            {
            ...
            },
            {
                ...
                "steps": [
                    ...
                    {"step": "Count remaining errors", "command": "wc -l /tmp/ruff_after.txt"},
                    {
            ...
            },
            {
                "name": "Commit changes",
                "steps": [
                    {"step": "Check what changed", "command": "git status --short"},
                    {"step": "Stage all changes", "command": "git add -A"},
                    {
                        "step": "Commit fixes",
